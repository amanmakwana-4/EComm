...
const ORDER_SUCCESS_META = {
  title: "Order Confirmed | Royal Pure Spices",
  description:
    "Your Royal Pure Spices order is confirmed. We'll notify you with shipping updates shortly.",
  path: "/order-success",
};
...
const OrderSuccess = () => {
  ...
  useEffect(() => {
    ...
    fetchOrder();
  }, [orderId]); // ← This useEffect ends correctly, no extra brace

  return (
    <>
      <Seo {...ORDER_SUCCESS_META} />
                    ...
                    order.items.map((it, idx) => (
                      <div key={idx} className="flex justify-between text-sm">
                        ...
                        <div className="text-right">
                          <div>
                            ₹{(it.price || 0).toFixed(2)} x {it.quantity}
                          </div>
